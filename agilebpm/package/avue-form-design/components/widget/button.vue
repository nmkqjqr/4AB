<template>
  <div class="widget-button">
    ...
    ></el-button>
    <el-button
      v-if="!info.isBo && ['item','group-item','table-item'].includes(type)"
      class="copy"
      title="复制"
      circle
      plain
...
<script setup>
  import { Brush, Delete, CopyDocument } from '@element-plus/icons-vue'
  ...
  const info = reactive({})
  info.isBo = abTools.useCurrentInstance().proxy.$route.query.mode != 'diyBo'
