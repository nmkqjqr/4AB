      ...
      <el-row>
        <el-col :span="12">
          <el-form
            ...
            :status-icon="false"
          >
            <el-form-item label="消息ID1" prop="id">
            ...
            <el-form-item label="重试原因" prop="retryCause">
              <el-input
                v-model="info.data.retryCause"
                :disabled="true"
                :rows="6"
                type="textarea"
              />
            ...
            <el-form-item>
              <ab-load
                ...
                v-model="info.data"
                :get-param="id"
                :url="cptApi.trxMessageRedoGetUrl"
              />
            </el-form-item>
          </el-form>
        </el-col>
