      ...
      <el-main>
        <div class="comprehensive-table-container">
          <div ref="titleForm">
            <el-row class="vab-query-form">
              <el-col class="top-panel">
                <el-form
                  ...
                  @submit.prevent
                >
                  <el-form-item :label="$abT('bpm.office.process', '流程')">
                    <el-input
            ...
            <el-row class="vab-query-form">
              <el-col class="left-panel">
                <router-link v-ab-btn-rights:userAgency_add to="AgentEdit">
          ...
          <ab-table
            ...
            :query-param="query"
            row-key="id"
            :url="bpmApi.bpmPluginAgent.bpmAgentListUrl"
          >
            <ab-column
              ab-template="flow"
            ...
            <template #edit="{ scope }">
              ...
              <router-link
                :to="{ name: 'AgentEdit', query: { id: scope.row.id } }"
              >
                <el-button text type="primary">
              ...
              <el-button
                v-ab-btn-rights:userAgency_del
              ...
              <el-button
                v-ab-btn-rights:userAgency_disable
