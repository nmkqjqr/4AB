      ...
      <el-main>
        <div class="comprehensive-table-container">
            ...
            <el-row class="vab-query-form">
              <el-col class="top-panel">
                ...
                >
                  ...
                  <el-form-item
                    :label="$abT('page.taskLsit.taskName', '任务名称')"
                    prop="name$VLK"
                  >
                    <el-input
                      v-model="query.name$VLK"
                      :placeholder="
                        $abT('page.taskLsit.enterTaskName', '请输入任务名称')
                      "
                    />
                  </el-form-item>
                  <el-form-item>
          ...
          >
            ...
            />
            <ab-column
              :label="$abT('page.taskLsit.candidate', '候选人')"
              min-width="200"
              prop="assigneeNames"
            />
            <ab-column
              ...
              <el-button
                ...
                @click="
                  sendAction(
                    ...
                    $abT('page.taskLsit.unassignMsg', '确定取消{a}的指派吗？', {
                      a: scope.row.title,
                    })
                  )
                "
...
<script lang="ts" setup>
  ...
  import { bpmApi, BpmImageDialog, abTools } from '~/agilebpm'
